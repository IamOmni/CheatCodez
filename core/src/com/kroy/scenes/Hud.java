...
public class Hud {
    ...
    public Hud(SpriteBatch sb){
        ...
        scoreLabel      = new Label(String.format("%d", score),       new com.badlogic.gdx.scenes.scene2d.ui.Label.LabelStyle(new BitmapFont(), com.badlogic.gdx.graphics.Color.WHITE));
